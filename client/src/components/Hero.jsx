  ...
  return (
    ...
    min-h-screen'>
        ...
        <div className='text-center mb-6'>
            <h1 className='test-3xl sm:text-5xl md:text-6xl 2xl:text-7xl
            font-semibold mx-auto leading-[1.2]'>Create amazing content <br /> with AI tools
            <span className='text-primary'>AI tools</span></h1>
            <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto
            max-sm:text-xs text-grey-600'>Transform your content creation with our site of premimum AI tools.
