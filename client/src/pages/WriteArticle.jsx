...
const WriteArticle = () => {
    ...
    const onSubmitHandler = async (e)=> {
        ...
        try{
            ...
            const prompt = `
            Write a detailed article about ${input}.

            Requirements:
            - Minimum ${selectedLength.text} words
            - Use headings and subheadings
            - Include introduction, body and conclusion
            - Do not write less than ${selectedLength.text - 100} words
            `
  ...
  return (
    ...
    text-slate-700'>
        ...
        border-gray-200'>
            ...
            bg-gradient-to-r from-[#226BFF] text-white px-4 py-2 mt-6
            text-sm rounded-lg cursor-pointer'> 
            {
                loading ? <span className='w-4 h-4 mt-1 rounded-full border-2
