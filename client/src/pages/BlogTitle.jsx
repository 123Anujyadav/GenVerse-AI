...
const BlogTitle = () => {
        const blogCategories = ['General', 'Technology','Business','Health',
            'LifeStyle','Eductaion','Travel','Food'
        ]
        ...
        const onSubmitHandler = async (e)=> {
            ...
            try{
                setLoading(true)
                const prompt = `Fenerate a blog title for the keyword ${input} in the
  ...
  return (
    ...
    text-slate-700'>
        ...
        border-gray-200'>
            ...
            bg-gradient-to-r from-[#2C341F6] to-[#8E37EB] text-white px-4 py-2 mt-6
