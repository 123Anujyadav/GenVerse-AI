...
const GenerateImages = () => {
  const imageStyle = ['Realistic','Gibli style', 'Anime style','Cartoon style',
    'Fantasy style','Relistic style','3D style','Portrait style']
          ...
          const onSubmitHandler = async (e)=> {
              ...
              try{
                setLoading(true)
                const prompt = `Gnerate an image of ${input} in the style ${selectedStyle}`
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex item-start flex-wrap gap-4
    text-slate-700'>
        {/* Left col */}
        ...
        border-gray-200'>
            ...
            <div className='my-6 flex item-center gap-2'>
              <label className='reletave cursor-pointer'>
        ...
        border-gray-200 min-h-96 '>
            ...
            {
                !content ? (<div className='flex-1 flex justify-center item-center'>
